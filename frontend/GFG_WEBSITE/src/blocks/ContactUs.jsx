...
const ContactUs = () => {
  return (
    <>
      <div class="font-[sans-serif] max-w-6xl mx-20 relative bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl overflow-hidden mt-4 mb-20 ">
        ...
        <div class="grid md:grid-cols-2 gap-8 py-8 px-6">
          ...
          <form class="rounded-tl-3xl rounded-bl-3xl">
            <h2 class="text-2xl text-blue-600 font-bold text-center mb-6">
              Contact us
            </h2>
            <div class="max-w-md mx-auto space-y-3 relative">
              ...
              <textarea
                placeholder="Message"
                rows="6"
                class="w-full bg-gray-100 rounded-md px-4 text-sm pt-3 outline-blue-600 focus-within:bg-transparent"
              ></textarea>
